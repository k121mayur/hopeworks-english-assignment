...
export default function Recorder({ onRecorded }) {
  ...
  return (
    <div className="flex flex-col w-full text-left">
      <div className="flex flex-row items-center justify-between p-5 gap-4 w-full text-left">
        ...
        <div className="relative group perspective-1000">
          ...
          <button
            ...
            className={`relative z-10 w-16 h-16 rounded-full flex items-center justify-center text-white shadow-lg transition-all duration-300 transform group-hover:-translate-y-1 ${
              recording
      ...
      {audioUrl && !recording && (
        <div className="w-full px-5 pb-5 pt-1 animate-fade-in text-left">
